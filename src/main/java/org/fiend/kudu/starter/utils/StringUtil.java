...
public abstract class StringUtil {
     ...
     * @return 出力金額
     */
    public static String formatCurrency(String amount, boolean markFlg, int maxSize) {
        boolean minus = false;
     ...
     * @return 出力金額
     */
    public static String formatCurrency(long amount, boolean markFlg, int maxSize) {
     ...
     * @return 文字列
     */
    public static String convertIntArrayToString(int[] intArray, String separate) {
     ...
     * @return 文字列
     */
    public static String convertStringArrayToString(String[] strArray, String separate) {
        String separateStr = nvl(separate);
     ...
     * @return 取り込んだバイト
     */
    public static byte[] getMiddleBytes(byte[] byteFrom, int startIndex, int length) {
     ...
     * @return 取り込んだ文字列
     */
    public static String getMiddleStringByByte(String inputStr, int startIndex, int length) {
        String retStr = "";
     ...
     * @return
     */
    public static String listToString(List<String> userIdList) {
        if (userIdList == null) {
            return null;
        }
